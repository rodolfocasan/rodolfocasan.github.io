// src/app/edu/national/Schools/Escuela.jsx
'use client'
...
const escuelaInfo = {
    institucion: "Educación Básica Nacional",
    periodo: "2006 - 2015",
    duracion: "9 años",
    grados: "1° a 9° Grado",
    pais: "El Salvador",
    descripcion: "Fundamentos educativos que marcaron el inicio de mi formación académica y personal",
    certificados: [
        {
            titulo: "Certificado de Estudios Básicos",
            descripcion: "Documento oficial que certifica la finalización exitosa de los 9 años de educación básica",
            imageUrl: "https://raw.githubusercontent.com/rodolfocasan/fetch-media/main/edu/national/escuela_certificado.jpg",
            tipo: "Certificado Oficial"
        },
        {
            titulo: "Carta de Recomendación",
            descripcion: "Carta institucional que respalda el desempeño académico y personal durante los años de estudio",
            imageUrl: "https://raw.githubusercontent.com/rodolfocasan/fetch-media/main/edu/national/escuela_carta.jpg",
            tipo: "Documento de Respaldo"
        }
    ],
    materias: [
        { nombre: "Matemáticas", icon: <FaCalculator className="w-5 h-5" />, color: "from-blue-500 to-cyan-600" },
        { nombre: "Lenguaje", icon: <FaLanguage className="w-5 h-5" />, color: "from-green-500 to-emerald-600" },
        { nombre: "Ciencias", icon: <FaFlask className="w-5 h-5" />, color: "from-purple-500 to-violet-600" },
        { nombre: "Estudios Sociales", icon: <FaGlobe className="w-5 h-5" />, color: "from-orange-500 to-red-600" },
        ...
        { nombre: "Educación Moral", icon: <FaHeart className="w-5 h-5" />, color: "from-red-500 to-pink-600" },
        { nombre: "Educación Musical", icon: <FaMusic className="w-5 h-5" />, color: "from-indigo-500 to-blue-600" }
    ]
}
...
function Escuela() {
    ...
    React.useEffect(() => {
        ...
        escuelaInfo.certificados.forEach((cert, index) => {
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-r from-green-500 to-blue-600 rounded-full mb-6">
                            <FaSchool className="w-12 h-12 text-white" />
                        </div>
                        ...
                        <h2 className="text-xl md:text-2xl lg:text-3xl text-gray-300 font-light mb-8 leading-relaxed max-w-4xl mx-auto">
                            Los{' '}
                            <span className="text-green-400 font-medium">cimientos fundamentales</span>{' '}
                            de mi{' '}
                            <span className="text-blue-400 font-medium">formación académica</span>{' '}
                            y{' '}
                            <span className="text-purple-400 font-medium">desarrollo personal</span>
                        </h2>
                        <p className="text-gray-400 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto">
                            Nueve años de formación integral que establecieron las bases de mi conocimiento,
                            desde el aprendizaje del habla y las matemáticas básicas hasta el desarrollo
                            de habilidades sociales y valores fundamentales.
                        </p>
                    </div>
                    ...
                    <div className="mb-16">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            {escuelaInfo.materias.map((materia, index) => (
                                <div
                                    key={index}
                    ...
                    <div className="mb-16">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            {escuelaInfo.certificados.map((cert, index) => (
                                <div
                                    key={index}
                                    className="relative"
                                >
